...
import { MessageCircle, Star, Truck, Diamond } from 'lucide-react';
import NavbarSarah from './navbar';
import Footer from './footer';
import Contacto from './Contacto';
import CuidadoJoyas from './CuidadoJoyas';
...
const Home = () => {
  ...
  return (
    <div className="min-vh-100">
      ...
      <div id="inicio" className="position-relative vh-100 d-flex align-items-center justify-content-center text-center"
        ...
        <div className="position-relative z-1 text-dark px-4">
          ...
          <div className="d-flex flex-column flex-sm-row justify-content-center gap-3">
            ...
            <Button
              as="a"
              href={`https://wa.me/573162911767?text=${encodeURIComponent('¡Hola! Soñé una pieza única y quiero hacerla realidad con Sarang. ¿Me cuentan cómo funciona el proceso?')}`}
              target="_blank"
              rel="noreferrer"
                    ...
                    <Col key={product.id} xs={12} sm={6} lg={3} className="d-flex justify-content-center">
                      <Card className="product-card h-100 border-0 shadow-sm text-center w-100">
                        ...
                        <Card.Body className="p-3">
                          ...
                          <Button
                            as="a"
                            href={`https://wa.me/573162911767?text=${encodeURIComponent(`¡Hola! Me encanta "${product.name}" de Sarang. ¿Me das más información sobre esta pieza?`)}`}
                            target="_blank"
                            rel="noreferrer"
      ...
      {/* Floating WhatsApp */}
      <a href={`https://wa.me/573162911767?text=${encodeURIComponent('¡Hola! Vi sus diseños y me fascinaron. ¿Me cuentan más sobre sus piezas?')}`} className="floating-whatsapp" target="_blank" rel="noreferrer">
