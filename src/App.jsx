...
//   const [itemsPerSlide, setItemsPerSlide] = useState(
//   window.innerWidth >= 992 ? 4 : 2
// );

// useEffect(() => {
//   const handleResize = () => {
//     setItemsPerSlide(window.innerWidth >= 992 ? 4 : 2);
//   };
//   window.addEventListener('resize', handleResize);
//   return () => window.removeEventListener('resize', handleResize);
// }, []);

// Calcula los grupos dinámicamente
const slideGroups = [];
for (let i = 0; i < bestSellers.length; i += itemsPerSlide) {
  ...
  <Container>
    ...
    {/* Botón WhatsApp visible solo en móvil, al lado del toggle */}
    ...
    <Navbar.Collapse id="main-nav" className="justify-content-center">
      <Nav className="gap-lg-4">
              <Nav.Link className="nav-link-custom" href="#inicio">Inicio</Nav.Link>
    ...
    <div className="d-none d-lg-flex">
      ...
      <section id='best-sellers' className="py-5 bg-ivory">
        <Container className="py-5">
          ...
          <Carousel
          fade //-> Cambiar por si esta muy feo
          indicators={false}
        ...
        <Container className="py-5 text-center">
          ...
          <Row className="g-4">
            {[
              ...
              { icon: <Sun />, title: "Lejos de cremas", desc: "Aplica perfumes y lociones antes de ponerte tus accesorios." },
          ...
          <Row className="gy-5">
            <Col md={3} className="text-center text-md-start">
              ...
              {/* <div className="d-flex justify-content-center justify-content-md-start gap-3">
                <a href="#" className="text-white hover-rose-gold transition-all"><Heart size={20} /></a>
                <a href="#" className="text-white hover-rose-gold transition-all"><ShoppingBag size={20} /></a>
              </div> */}
            </Col>
            <Col md={3} className="text-center text-md-start">
            ...
            <Col md={3} className="text-center text-md-start">
              ...
              <ul className="list-unstyled text-white-50 small">
                ...
                {/* <li><a href="#" className="text-decoration-none text-white-50">Términos y Condiciones</a></li>
                <li><a href="#" className="text-decoration-none text-white-50">Preguntas Frecuentes</a></li> */}
              </ul>
            </Col>
            <Col md={3} className="text-center text-md-start">
